...
response2 = requests.post(url=f"{URL}/scoring").content
response3 = requests.post(url=f"{URL}/summarystats").content
response4 = requests.post(url=f"{URL}/diagnostics").content
